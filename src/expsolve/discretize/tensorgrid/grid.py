...
# This file is common to all tensorized grid level operations
# This will include Fourier and finite differences
# These should not need spectral aspects, therefore resample should go to spectral.py
